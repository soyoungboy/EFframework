...
//                    mActivity, clickedView, transitionName);
    ...
    public void setOrAnimatePlusCheckIcon(final ImageView imageView, boolean isCheck,
        ...
        if (!(drawable instanceof AnimatedStateListDrawable)) {
            drawable = mActivity.getResources().getDrawable(R.drawable.abc_btn_switch_to_on_mtrl_00001);
            imageView.setImageDrawable(drawable);
        }
        imageView.setColorFilter(isCheck ?
                mActivity.getResources().getColor(R.color.primary_material_light) : Color.WHITE);
        if (allowAnimate) {
